...
另外，请注意，一旦密码按照要求的标准生成，我们会在最后进行洗牌。对于洗牌，我们先把它转换成符文数组。请参考这篇文章，了解为什么要洗牌–[https://golangbyexample.com/shuffle-string-golang/](https://golangbyexample.com/shuffle-string-golang/)
