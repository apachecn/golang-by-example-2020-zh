...
**时间**或**日期**用**时间表示在Golang中。时间**结构。时间也可以表示为
...
**持续时间**是两个瞬间之间经过的时间。它被表示为**纳秒**计数。所以持续时间在Golang中算不了什么，只是一个以纳秒为单位表示时间的数字。因此，如果持续时间值等于**10000000000**，则表示 **1 秒**或 **1000 毫秒**或 **10000000000 纳秒**
