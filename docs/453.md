...
> 原文:[https://golangbyexample.com/set-cookie-response-header/](https://golangbyexample.com/set-cookie-response-header/)
...
<figure class="wp-block-image size-large">![cookie_set_request](../Images/5743ff6b7299452f20052240e39f56a7.png)</figure>

现在让我们从不同的选项卡进行另一个 API 调用。请注意，响应中会发回相同的 cookie。还要注意，只有名称-值对被发送回来，正如我们在本文上面提到的

<figure class="wp-block-image size-large">![cookie_send_request](../Images/a3c457587ceebc81af0674c0439a1889.png)</figure>
